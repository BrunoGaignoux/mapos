...
<div class="widget-box">
	...
	<div style="col col-md-12 align-center">
	<!--<a id="imprimir" style="margin-right: 1%" href="" class="btn tip-top" title="Imprimir Lançamento"><i class="icon-print"></i> Imprimir Registros de Lançamentos</a>
	</div>-->

<div class="widget-content nopadding" id="printFinance">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function Popup(data)
        {
            ...
            mywindow.document.write('<html><head><title>WoS</title>');
