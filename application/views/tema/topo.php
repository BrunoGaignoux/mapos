...
<html lang="en">
<head>
<title>Wo Sistemas</title>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link rel="shortcut icon" href="<?php echo base_url();?>/ico-wosistemas.ico" type="image/x-icon"/>
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="pull-right"><a href="https://wosistemas.com.br" target="_blank"><i class="icon icon-asterisk"></i> <span class="text">Versão: <?php echo $this->config->item('app_version'); ?></span></a></li>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="https://wosistemas.com.br" target="_blank"><?php echo date('Y'); ?> Copyright &copy; Wo Sistemas LTDA</a></div>
</div>
<!--end-Footer-part-->
