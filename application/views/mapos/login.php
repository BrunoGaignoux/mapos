...
<head>
        <title>Wo Sistemas</title><meta charset="UTF-8" />
	<link rel="icon" href="<?php echo base_url()?>assets/img/ico-wosistemas.ico" type="image/x-icon">
