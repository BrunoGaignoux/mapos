            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        ...
                        <li id="tabDespesas"><a href="#tab5" data-toggle="tab">Despesas</a></li>
                    </ul>
                    <div class="tab-content">
						...
						<option <?php if($result->status == 'Quitado'){echo 'selected';} ?> value="Quitado">Quitado</option>
                        ...
                        <div class="tab-pane" id="tab5">
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                <div class="span12 well" style="padding: 1%; margin-left: 0" id="form-despesas">
                                    <form id="formDespesas" action="<?php echo base_url() ?>index.php/os/adicionarDespesas" method="post">
                                    <div class="span8">
                                        <input type="hidden" name="idDespesa" id="idDespesa" />
                                        <input type="hidden" name="idOsDespesa" id="idOsDespesa" value="<?php echo $result->idOs?>" />
                                        <input type="hidden" name="estoque" id="estoque" value=""/>
                                        <input type="hidden" name="valor" id="valor" value=""/>
                                        <label for="">Despesa</label>
                                        <input type="text" class="span12" name="despesa" id="despesa" placeholder="Digite a despesa desejada" />
                                    </div>
                                    <div class="span2">
                                        <label for="">Valor</label>
                                        <input type="text" placeholder="Valor da despesa" id="valorDespesa" name="valorDespesa" class="span12" />
                                    </div>
                                    <div class="span2">
                                        <label for="">.</label>
                                        <button class="btn btn-success span12" id="btnAdicionarDespesa"><i class="icon-white icon-plus"></i> Adicionar</button>
                                    </div>
                                </form>
                                </div>
                                <div class="span12" id="divDespesas" style="margin-left: 0">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Despesa obtida</th>
                                                <th>Valor</th>
                                            </tr>
                                        </thead>
                                        <?php
                                           $despesas = $this->input->post('btnAdicionarDespesa');
                                            if ($despesas==true) {
                                            $despesa = $this->input->post('despesa');
                                            $valor = $this->input->post('valorDespesa');

                                            echo '<tbody>'; 
                                            echo '<tr>';
                                            echo '<td>'.$despesa.'</td>';
                                            echo '<td><span idAcao="'.$d->idDespesa.'" title="Excluir Despesa" class="btn btn-danger"><i class="icon-remove icon-white"></i></span></td>';
      ...
      <div id="divRecebimento" class="span8" style=" display: none">
        ...
        <div class="span6">
          ...
          <select name="formaPgto" id="formaPgto" class="span12">
            ...
            <option value="Débito">Permuta</option>
            <option value="Débito">Garantia</option>            
          </select> 
      </div>
