...
class Financeiro extends CI_Controller {
                ...
                if($periodo == 'semana'){
                    ...
                    // busca lançamentos do ano
                        ...
                        if(! isset($situacao) || $situacao == 'todos'){
                            ...
                            if($situacao == 'previsto'){
                                $where = 'data_vencimento BETWEEN "'.strtotime(date('Y-m-d')).'" AND "'.$ano[1].'" AND baixado = "0"'; 
                            }
                            else{
                                if($situacao == 'atrasado'){
                                    $where = 'data_vencimento BETWEEN "'.$ano[0].'" AND "'.strtotime(date('Y-m-d')).'" AND baixado = "0"'; 
                                }
                                else{
                                    if($situacao == 'realizado'){
    ...
    function visualizar() {
        ...
        $this->data['view'] = 'financeiro/visualizarLancamento';
        $this->load->view('tema/topo', $this->data);
